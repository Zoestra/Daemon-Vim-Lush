...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Cursor({ bg = hsl(357, 74, 40) }), -- Character under the cursor
		-- CurSearch      { }, -- Highlighting a search pattern under the cursor (see 'hlsearch')
		lCursor({ bg = hsl(357, 74, 40), fg = hsl(184, 99, 68) }), -- Character under the cursor when |language-mapping| is used (see 'guicursor')
		-- CursorIM       { }, -- Like Cursor, but used when in IME mode |CursorIM|
		-- CursorColumn   { }, -- Screen-column at the cursor, when 'cursorcolumn' is set.
		CursorLine({ bg = hsl(184, 10, 20) }), -- Screen-line at the cursor, when 'cursorline' is set. Low-priority if foreground (ctermfg OR guifg) is not set.
		...
		Normal({ bg = hsl(349, 44, 7), fg = hsl(184, 99, 68) }), -- Normal text
		...
		Error({ bg = hsl(357, 74, 40), fg = hsl(183, 89, 85) }), -- Any erroneous construct
		Todo({ fg = hsl(149, 67, 47) }), -- Anything that needs extra attention; mostly the keywords TODO FIXME and XXX
